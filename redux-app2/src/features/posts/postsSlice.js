...
const postsSlice = createSlice({
  ...
  reducers: {
    ...
    // can be just the reducer function name + body. Otherwise, an object body (with prepare here).
    postAdded: {
      ...
      prepare(title, content, userId) {
        // prepare: sets up new post. That means calling it just provides a few things and doesn't need to worry about body.
        return {
          payload: {
            id: nanoid(),
            title,
...
export const selectAllPosts = (state) => state.posts.posts; //so that the useSelector will work more often, we jsut change here. Whenever we call useSelector we don't have to rewrite code.
